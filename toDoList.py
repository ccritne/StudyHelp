...
def seeToDoList():
    ...
    layout = [
        [
            sg.InputText(
                key="selectedDate",
                default_text=getStringDate(getSelectedDate()),
                size=(10, 1),
            ),
        ...
        if event is not None:
            ...
            if event in ["selectToDoDate", "selectedDate_Enter"]:
                ...
                if event == "selectToDoDate":
                    ...
                    selectedDate = sg.popup_get_date(
                    ...
                    sDate = (
                        fromNumberToTime(selectedDate[2])
                        + "-"
                        + fromNumberToTime(selectedDate[0])
                        + "-"
                        + fromNumberToTime(selectedDate[1])
                    )
